    ...
    <>
      ...
      <div className="flex flex-col min-h-screen pt-24 bg-[#FFF9F5]">
        ...
        <SectionWrapper background="cream">
          ...
          <div className="relative w-full max-w-5xl mx-auto aspect-video rounded-[3rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(249,115,22,0.15)] bg-white border border-orange-100/50">
            <Image 
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-slate-900">{config.contact?.phone || '+91 9734876490'}</p>
                    </div>
                  </div>
                </div>
